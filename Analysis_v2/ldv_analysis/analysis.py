...
def prepare_geometry(cfg, sag_use_3d=True, sag_use_parabola=False):
    ...
    # Sag measurement uncertainty: RMS residual of the constrained parabola fit
    # (how far the sensor positions scatter around the fitted sag curve).
    sag_diag = sag_fit_diagnostics(cfg['XYZ'], cfg['idx_left'], cfg['idx_right'])
    ...
    cfg.update(dict(
        ...
        sag_rms_residual=sag_diag['rms_residual'],
